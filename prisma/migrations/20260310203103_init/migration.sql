...
-- CreateIndex
CREATE UNIQUE INDEX "SellerApplication_shopName_key" ON "SellerApplication"("shopName");
...
-- CreateIndex
CREATE INDEX "AuditLog_actorAdmin_idx" ON "AuditLog"("actorAdmin");
...
-- AddForeignKey
ALTER TABLE "AuditLog" ADD CONSTRAINT "AuditLog_actorAdmin_fkey" FOREIGN KEY ("actorAdmin") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
